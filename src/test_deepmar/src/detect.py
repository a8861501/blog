...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/home/boychen/Desktop/R-DAP/follow_person/ros_ws/src/test_deepmar/src/weights/yolov5s.pt', help='model.pt path')
...
#     model_deepmar = torch.load('./deepmar/deepmar.pth')
    ...
    model_deepmar.load_state_dict(torch.load('/home/boychen/Desktop/R-DAP/follow_person/ros_ws/src/test_deepmar/src/weights/deepmar_statedict.pth'))
    model_deepmar.eval()
    model_deepmar.cuda()
