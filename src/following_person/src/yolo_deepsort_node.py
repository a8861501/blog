...
if __name__ == '__main__':
    ...
    # deepsort parameters
    parser.add_argument("--config_deepsort", type=str, default="/home/boychen/Desktop/R-DAP/follow_person/ros_ws/src/following_person/src/configs/deep_sort.yaml")
